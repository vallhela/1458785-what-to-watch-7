...
function MoviePageScreen(props) {
  ...
  const alike = films.filter((p) => p.genre === film.genre && p.id !== film.id);
          ...
          <div className="film-card__wrap">
            <div className="film-card__desc">
              ...
              <div className="film-card__buttons">
                ...
                <Link to={{pathname: `/films/${film.id}/review`}} className="btn film-card__button">Add review</Link>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="film-card__info">
            ...
            <div className="film-card__desc">
              ...
              <div className="film-card__text">
                ...
                <p className="film-card__starring"><strong>Starring: {film.starring.slice(0,4).join(', ')}{film.starring.length> 4 && ' and other'}</strong></p>
              </div>
            </div>
          </div>
        </div>
...
MoviePageScreen.propTypes = prop;
